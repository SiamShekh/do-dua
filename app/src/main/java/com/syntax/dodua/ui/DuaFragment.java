...
public class DuaFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.list_title)).setText(R.string.nav_dua);
        ...
        bindTabs(view.findViewById(R.id.tabs_row), data.duaCategories());
        refresh();
    }
    ...
    private void refresh() {
        adapter.submit(data.filter(data.duas(), selected));
    }
